package com.cloudht.system.config;

import at.pollux.thymeleaf.shiro.dialect.ShiroDialect;
import com.cloudht.common.config.Constant;
import com.cloudht.common.redis.shiro.RedisCacheManager;
import com.cloudht.common.redis.shiro.RedisManager;
import com.cloudht.common.redis.shiro.RedisSessionDAO;
import com.cloudht.system.shiro.UserRealm;
...
//    CacheManager cacheManager;
    ...
    ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/sys/user/registerSave", "anon");//开放注册保存用户页面
        filterChainDefinitionMap.put("/register", "anon");//开放注册用户页面
